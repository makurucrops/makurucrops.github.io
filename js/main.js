...
const I18N = {
  en: {
    ...
    lablab beans: "lablab beans", lablab beansText: "Drought-tolerant lablab beans (kunde) with strong flavour and nutrition for everyday cooking.",
  ...
  sw: {
    ...
    lablab beans: "Kunde", lablab beansText: "Kunde zinazostahimili ukame, zenye ladha na lishe nzuri kwa mapishi ya kila siku.",
