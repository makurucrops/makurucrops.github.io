...
const I18N = {
  en: {
    ...
    heroLead: "Makuru Crops Company produces and distributes maize, beans, lablab beans, and lentils — with farming, irrigation, and farm management support.",
    ...
    lablab: "Lablab beans", lablabText: "Drought-tolerant lablab beans (ngwara) with strong flavour and nutrition for everyday cooking.",
    ...
    footerVisit: "Visit",
    footerBlurb: "Sustainable crop production and reliable distribution of maize, beans, lablab beans, and lentils.",
  ...
  sw: {
    ...
    heroLead: "Makuru Crops Company inazalisha na kusambaza mahindi, maharagwe, ngwara, na dengu — pamoja na kilimo, umwagiliaji, na usimamizi wa mashamba.",
    ...
    lablab: "Ngwara", lablabText: "Ngwara zinazostahimili ukame, zenye ladha na lishe nzuri kwa mapishi ya kila siku.",
    ...
    footerBlurb: "Uzaji endelevu wa mazao na usambazaji wa kuaminika wa mahindi, maharagwe, ngwara, na dengu.",
